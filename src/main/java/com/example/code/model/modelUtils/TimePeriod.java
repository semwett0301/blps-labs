...
public class TimePeriod {
    ...
    public boolean isAvailableForCouriersInThisDay(List<UserInfo> couriers, int day) {
        boolean isAvailable = false;
        for (UserInfo courier : couriers) {
    ...
    public boolean isAvailableForCourierInThisDay(UserInfo courier, int day) {
        List<Order> currentOrders = courier.getOrdersFromCourierByDay(day);
